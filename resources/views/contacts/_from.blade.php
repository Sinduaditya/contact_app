<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" name="email" value="{{ old('email', $contact->email) }}" id="email"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" name="phone" value="{{ old('phone', $contact->phone) }}" id="phone"
            ...
            <div class="col-md-9">
                <select name="company_id" id="company_id"
                    ...
                    @foreach ($companies as $id => $name)
                        <option value="{{ $id }}" @selected($id == old('company_id', $contact->company_id))>
                            {{ $name }}</option>
                    @endforeach
                </select>
                @error('company_id')
