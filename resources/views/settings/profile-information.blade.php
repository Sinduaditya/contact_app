...
@section('title', 'Contact App | Profile Informations')
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        @if (session('status') == 'profile-information-updated')
                                            <div class="alert alert-success">Profile Information Updated</div>
                                        @endif
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <div class="mt-2">
                                                    <span class="btn btn-outline-secondary btn-file"><span
                                                            ...
                                                            type="file" name="profile_picture" accept="image/*"></span>
